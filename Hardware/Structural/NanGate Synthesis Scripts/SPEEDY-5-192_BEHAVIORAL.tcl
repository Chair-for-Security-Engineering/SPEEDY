# Setting Environment
cd my_designs/SPEEDY-5-192_45nm/Structural
## Clean Workspace
...
write -format verilog -hierarchy -output "Netlist_45nm/SPEEDY-5-192.v"
change_names -rules vhdl -hier
write -format vhdl -hierarchy -output "Netlist_45nm/SPEEDY-5-192.vhd"



# Reporting
file mkdir Report_45nm
report_timing -significant_digits 13 > "Report_45nm/SPEEDY-5-192.tim.rpt"
report_area -hierarchy > "Report_45nm/SPEEDY-5-192.area.rpt"
create_clock -period 10.0 -name my_clock [get_ports clk]
report_power -analysis_effort high -verbose > "Report_45nm/SPEEDY-5-192.power.rpt"
...
remove_design -all
# Setting Environment
cd ../../SPEEDY-5-192_15nm/Structural
## Clean Workspace
if [file exists WORK] {file delete -force WORK}
## Define Design Lib
file mkdir WORK
...
write -format verilog -hierarchy -output "Netlist_15nm/SPEEDY-5-192.v"
change_names -rules vhdl -hier
write -format vhdl -hierarchy -output "Netlist_15nm/SPEEDY-5-192.vhd"



# Reporting
file mkdir Report_15nm
report_timing -significant_digits 13 > "Report_15nm/SPEEDY-5-192.tim.rpt"
report_area -hierarchy > "Report_15nm/SPEEDY-5-192.area.rpt"
create_clock -period 10000.0 -name my_clock [get_ports clk]
report_power -analysis_effort high -verbose > "Report_15nm/SPEEDY-5-192.power.rpt"